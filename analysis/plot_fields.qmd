...
muni_info <- read_sheet("https://docs.google.com/spreadsheets/d/1ti8Cmagl8GZ_7BV40aj4U5xjV-cTjEKB8LAegFt7XCQ", 
                        sheet = "town_lookups_2025")

info_source <- read_sheet("https://docs.google.com/spreadsheets/d/1ti8Cmagl8GZ_7BV40aj4U5xjV-cTjEKB8LAegFt7XCQ", 
                          sheet = "sources_2025", col_types = "c" )

write_csv(muni_info, file = "../output/muni_info_2025.csv")
write_csv(info_source, file = "../output/info_source_2025.csv")
```
...
read_csv("../output/info_source_2025.csv", col_types = "c") |> gt() |> 
...
saveRDS(ma_munis, file = "../output/ma_muni_2025.rds")
```
